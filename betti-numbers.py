'''
THIS FILE SERVES AS A REFERENCE FOR OUR PROJECT
ALL CODE IS COURTESY OF KENNETH HOWE
https://github.com/kc-howe/Betti-Numbers/blob/master/simplicial_complex.py
'''
